...
<footer class="footer">
	<div class="container-fluid">
		<div class="row">
				...
				<ul class="nav--footer">
					...
					<li class="nav__item nav__item--title">
						...
						<ul>
							...
							<li class="nav__item"><a href="#"><span>Ambientale</span></a></li>
			...
			<div class="col-sm-20 offset-sm-2 offset-md-0 col-md-2">
				<ul class="nav--social">
					<li class="nav__item"><a href="#"><svg class="linkedin"><use xlink:href="#linkedin"></use></svg></a></li>
					<li class="nav__item"><a href="#"><svg class="twitter"><use xlink:href="#twitter"></use></svg></a></li>
				</ul>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col-sm-10 offset-sm-2">
				<div class="footer__colophon">
					<span>©2021 Aquafil S.p.A. - P.IVA 09652170961</span> - <a href="#" class="btn--link">Privacy</a>
				</div>
			</div>
			<div class="col-sm-10">
