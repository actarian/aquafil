			...
			<div class="col-md-6">
				...
				<div class="card--address">
					<div class="card--address__content">
						<div class="card--address__name" [innerHTML]="user.firstName + ' ' + user.lastName"></div>
						<div class="card--address__occupation" [innerHTML]="occupationName"></div>
						<div class="card--address__company" [innerHTML]="user.company"></div>
						<div class="card--address__address" [innerHTML]="user.address" *if="user.address"></div>
						<div class="card--address__address">
							<span class="card--address__zipcode" [innerHTML]="user.zipCode" *if="user.zipCode"></span>
							<span class="card--address__city" [innerHTML]="user.city"></span>
							<span class="card--address__country" [innerHTML]="countryName"></span>
						</div>
						<div class="card--address__phones" *if="user.telephone">
							<a class="card--address__phone" [href]="'tel:' + user.telephone" [innerHTML]="user.telephone"></a>
						</div>
						<a class="card--address__email" [href]="'mailto:' + user.email" [innerHTML]="user.email"></a>
						<div class="card--address__newsletter" *if="user.newsletter">
